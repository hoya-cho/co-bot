...
Configs = dict(
    ...
    custom_imports = dict(
        allow_failed_imports=False, imports=[
            'gtgen.mot2d.config.projects.CO-DETR.codetr',
        ]),
    data_root = '/',
    ...
    test_dataloader = dict(
        ...
        dataset=dict(
            _scope_='mmdet',
            ann_file='ext/hoya/AI_HUB_TCB_coco_val.json',
            backend_args=None,
            data_prefix=dict(
                img=
    ...
    train_dataloader = dict(
        batch_size=1,
        dataset=dict(
            ann_file='ext/hoya/ai_hub_1+5_train_coco_new_simple.json',
            backend_args=None,
            data_prefix=dict(img='/ext/mlops/1_train_dataset/1.O.D'),
            data_root='/',
