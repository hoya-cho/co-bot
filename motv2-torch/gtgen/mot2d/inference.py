...
from gtgen.botsort.tracker.mc_bot_sort import BoTSORT
from gtgen.botsort.tracker.tracking_utils.timer import Timer
import argparse
...
class GtGenMot2dInference(GtGen2dMultiOfTrackingV2Abstract, GtGenModelInferenceAbstract):
    ...
    def inference(self,
        ...
        cfg = '/ext/aihub_codetr/20240405_014338/vis_data/config.py'      
        load_from = '/ext/aihub_codetr/epoch_3.pth'
        model = init_detector(cfg, load_from, device='cuda:0')
        # build test pipeline
